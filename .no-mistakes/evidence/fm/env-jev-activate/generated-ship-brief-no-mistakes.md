...
1. First action: create your branch: `git checkout -b fm/ship-jev-demo`
...
4. Report status by appending one line:
   `echo "{state} [at=<epoch>]: {one short line}" >> '/var/folders/c7/bb78qxx56b52ttgxx5bmdknm0000gn/T//fm-jev-brief-home.LUfP1B/state/ship-jev-demo.status'`
...
6. If a decision belongs above the implementation worker (product choices, destructive actions),
   ...
   For a no-mistakes ask-user gate specifically, escalate all ask-user findings as one event plus one snapshot file, using that same shape even when the gate holds only a single ask-user finding: write only the ask-user findings, verbatim and unparaphrased (id, severity, file, line, description, authority), to `/var/folders/c7/bb78qxx56b52ttgxx5bmdknm0000gn/T//fm-jev-brief-home.LUfP1B/data/ship-jev-demo/nm-<run>-findings.txt`, then report the gate with
   `needs-decision [at=<epoch>] [key=nm-<run>-<step>]: ask-user findings=<id1>,<id2>,... file=/var/folders/c7/bb78qxx56b52ttgxx5bmdknm0000gn/T//fm-jev-brief-home.LUfP1B/data/ship-jev-demo/nm-<run>-findings.txt`
...
Firstmate steers you through durable message files in '/var/folders/c7/bb78qxx56b52ttgxx5bmdknm0000gn/T//fm-jev-brief-home.LUfP1B/state/ship-jev-demo.inbox'.
When a terminal message says an instruction is waiting there - and at any natural checkpoint when you are unsure - list '/var/folders/c7/bb78qxx56b52ttgxx5bmdknm0000gn/T//fm-jev-brief-home.LUfP1B/state/ship-jev-demo.inbox'/*.msg, read and act on each message in numeric order, then acknowledge each handled message by moving it: `mv '/var/folders/c7/bb78qxx56b52ttgxx5bmdknm0000gn/T//fm-jev-brief-home.LUfP1B/state/ship-jev-demo.inbox'/NNN.msg '/var/folders/c7/bb78qxx56b52ttgxx5bmdknm0000gn/T//fm-jev-brief-home.LUfP1B/state/ship-jev-demo.inbox'/handled/`.
The move IS the acknowledgement: without it firstmate rings again and eventually treats you as stuck. An empty or absent inbox needs no action.

# Project memory
If `AGENTS.md` or `CLAUDE.md` already exists, or if this task produced durable project-intrinsic knowledge, run `/Users/danielkuykendall/.no-mistakes/worktrees/6ada68ffd386/01M33RQC0BH50Z3SF7DCM5AHT0/bin/fm-ensure-agents-md.sh .` in the worktree.
Record only project knowledge useful to almost every future session.
For anything the codebase already shows, prefer a pointer to the authoritative file, command, or doc over copying the detail.
If you touch a project `AGENTS.md`, follow `/Users/danielkuykendall/.no-mistakes/worktrees/6ada68ffd386/01M33RQC0BH50Z3SF7DCM5AHT0/bin/fm-ensure-agents-md.sh`'s self-governance contract in the same pass.
...
Use `/Users/danielkuykendall/.no-mistakes/worktrees/6ada68ffd386/01M33RQC0BH50Z3SF7DCM5AHT0/bin/fm-jev-desktop.sh run --access-approved --ui-approved --app <App> --no-values "<bounded reversible goal>"` or `/Users/danielkuykendall/.no-mistakes/worktrees/6ada68ffd386/01M33RQC0BH50Z3SF7DCM5AHT0/bin/fm-jev-desktop.sh act --access-approved --ui-approved --app <App> "<one step>"`.
...
Write the final evaluation JSON to `/var/folders/c7/bb78qxx56b52ttgxx5bmdknm0000gn/T//fm-jev-brief-home.LUfP1B/data/ship-jev-demo/jev-review.json` and append one `working [at=<epoch>]:` line with scores and deltas.
