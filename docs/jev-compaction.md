...
Because each Jev summary is verbatim rather than paraphrased, summaries accumulate across compactions, and the 25% reduction gate only ever measures the newly compacted region, never the carried-forward text.
